...
namespace BussinesAccess.Helper
{
    public static class MetricHelper
    {
        ...
        public static IEnumerable<IEnumerable<MetricValue>> ReadMetricDataUsingTasks(IEnumerable<Uri> uris)
        {
            return ReadMetricDataUsingTasks(uris, CertLoader.Load());
        }
        ...
        public static IEnumerable<MetricValue> ReadMetricData(Uri uri)
        {

            return ReadMetricData(uri, CertLoader.Load());
        }
        ...
        public static Task<IEnumerable<MetricInfo>> GetSupportedMetricsAsync(Uri uri)
        {
            return InternalGetSupportedMetricsAsync(uri, CertLoader.Load());
        }
        #endregion
